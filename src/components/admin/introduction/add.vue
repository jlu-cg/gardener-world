<template>
  <div>
    <el-row>
      <el-col :span="24">
        <el-page-header @back="backToList" content="修改详细介绍">
        </el-page-header>
      </el-col>
    </el-row>
    <el-row>
      ...
      <el-col :span="24">
        ...
        <el-form ref="detailIntroduction" :model="detailIntroduction" label-width="120px">
          <el-form-item label="简介">
            <el-input v-model="detailIntroduction.summary"></el-input>
          </el-form-item>
          <el-form-item label="内容">
            <quill-editor class="editor"
                        v-model="detailIntroduction.content"
...
<script>
export default {
  name: 'AdminDetailIntroductionAdd',
  data() {
    return {
      detailIntroduction : {
        id : -1,
  ...
  methods:{
    ...
    onSubmit() {this.axios.post(this.gardener.adminBackBaseURL + 'detail/introduction/v1/save', this.detailIntroduction)
      .then((response) => {
        if(response.data == 0){
