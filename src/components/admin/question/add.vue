<template>
  <div>
    <el-row>
      <el-col :span="24">
        <el-page-header @back="backToList" content="修改问题">
        </el-page-header>
      </el-col>
    </el-row>
    <el-row>
      ...
      <el-col :span="24">
        ...
        <el-form ref="question" :model="question" label-width="120px">
          <el-form-item label="名称">
            <el-input v-model="question.summary"></el-input>
          </el-form-item>
...
export default {
  ...
  methods:{
    ...
    onSubmit() {this.axios.post(this.gardener.adminBackBaseURL + 'question/v1/save', this.question)
      .then((response) => {
        if(response.data == 0){
